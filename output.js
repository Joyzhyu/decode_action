//Sat Oct 26 2024 13:07:46 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x48fae2 = _0x43ee01("顺丰速运");
const _0x12390c = require("got");
const _0x2fc3df = require("crypto-js");
const {
  CookieJar: _0x4dddc9
} = require("tough-cookie");
const _0x2bcd51 = "sfsy";
const _0x3606f0 = /[\n]/;
const _0x2e2a03 = [_0x2bcd51 + "Url"];
const _0x4a4977 = process.env[_0x2bcd51 + "Bee"] || "false";
const _0x56c230 = process.env[_0x2bcd51 + "2024Draw"] || "false";
const _0x129508 = 8000;
const _0x6e9601 = 3;
const _0xbb27d8 = 2.21;
const _0x375e27 = "sfsy";
const _0x10a462 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/code.json";
const _0x416ed4 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/" + _0x375e27 + ".json";
const _0x4e068d = "Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148";
const _0x5ca23f = "wwesldfs29aniversaryvdld29";
const _0x155333 = "MCS-MIMP-CORE";
const _0x3407f7 = "czflqdlhbxcx";
const _0x54e565 = "wxwd26mem1";
const _0x31cebf = [0, 1, 2];
const _0x2a7144 = {
  BAOZHU_CARD: "[爆竹卡]",
  CHUNLIAN_CARD: "[春联卡]",
  DENGLONG_CARD: "[灯笼卡]",
...
const _0x51d69b = "ANNIVERSARY_2024";
const _0x4b9d76 = "MEMBER_DAY";
const _0x148a2e = "DRAGONBOAT_2024";
const _0x57cac7 = 8;
const _0x24fae8 = 1 << _0x57cac7 - 1;
const _0x1be432 = ["完成连签7天", "参与积分活动", "每月累计寄件", "完成每月任务", "与好友微信分享会员福利", "DAILY_VIP_TASK_TYPE", "去新增一个收件偏好", "用行业模板寄件下单"];
let _0x567431 = [];
let _0x2193de = {};
class _0x1373e1 {
  constructor() {
  ...
  log(_0x2ae315, _0x3fbfa5 = {}) {
    var _0xe21cf0 = "";
    var _0x52cae0 = _0x48fae2.userCount.toString().length;
    if (this.index) {
  ...
  async request(_0x5e2905) {
    ...
    const _0x27e2a3 = ["TimeoutError"];
    var _0x4a3c9d = null;
    var _0xd3d5e2 = 0;
    var _0x52fc58 = _0x5e2905.fn || _0x5e2905.url;
    ...
    while (_0xd3d5e2 < _0x6e9601) {
      try {
        ...
        _0x156c7f = null;
        let _0x1ce3e4 = null;
        let _0x24e6ad = _0x5e2905?.["timeout"] || this.got?.["defaults"]?.["options"]?.["timeout"]?.["request"] || _0x129508;
        let _0x21ac48 = false;
...
class _0x1799fa extends _0x1373e1 {
  ...
  getSign(_0x76acdc = {}) {
    ...
    let _0xd0097e = "token=" + _0x5ca23f + "&timestamp=" + _0x4b899c + "&sysCode=" + _0x155333;
    let _0x3a7a87 = _0x2fc3df.MD5(_0xd0097e).toString();
    const _0x593eb6 = {
  ...
  async queryUserInfo(_0x454f9a = {}) {
    try {
      ...
      if (_0x381c6a?.["success"]) {
        ...
        let _0x12b90f = "积分: " + _0x31a856;
        let _0x2a10cb = _0x4eb1d5 - _0x213310;
        let _0x29a1ee = new Date(_0x4f875b + " 00:00:00");
  ...
  async superWelfare_receiveRedPacket(_0x510f1c = {}) {
    try {
      ...
      if (_0x4dd86c?.["success"]) {
        ...
        let _0x4da56f = _0x4dd86c?.["obj"]?.["receiveStatus"] == 1 ? "领取成功" : "已领取过";
        const _0x3dea03 = {
          notify: true
        };
    ...
    try {
      ...
      if (_0x273d17?.["success"]) {
        ...
        for (let _0x390ded of receivedAccountList) {
          _0x169581.push("" + (_0x2a7144[_0x390ded.currency] || "[" + _0x390ded.currency + "]"));
        }
    ...
    try {
      ...
      if (_0x393c14?.["success"]) {
        ...
        for (let _0x2c5a20 of receivedAccountList) {
          _0x106266.push("" + (_0x2a7144[_0x2c5a20.currency] || "[" + _0x2c5a20.currency + "]"));
        }
      ...
      if (_0xd474ec?.["success"]) {
        ...
        if (_0x4c0e70) {
          ...
          for (let _0x57cfda of _0x4c7663) {
            _0x14be2a.push("" + (_0x2a7144[_0x57cfda.currency] || "[" + _0x57cfda.currency + "]"));
          }
      ...
      if (_0x591aee?.["success"]) {
        ...
        if (_0x168766?.["length"]) {
          ...
          for (let _0x323242 of this.cards) {
            let _0x4164b0 = _0x2a7144[_0x323242.currency] || "[" + _0x323242.currency + "]";
      ...
      if (_0x16c3ba?.["success"]) {
        ...
        for (let _0x376c8a of _0x376ba0) {
          if (!_0x376c8a.received) {
            ...
            let _0x70d9bf = new Date(_0x376c8a.receiveEndTime);
            let _0xdbdf84 = Date.now();
  ...
  async anniversary2024_unbox(_0x568075 = {}) {
    try {
      ...
      if (_0x59e841?.["success"]) {
        let _0x5708cd = [];
        let _0x41c763 = _0x59e841?.["obj"]?.["account"]?.["receivedAccountList"] || [];
  ...
  async anniversary2024_TopicPk_topicList(_0x46183d = {}) {
    try {
      ...
      if (_0x45376b?.["success"]) {
        ...
        let _0x558796 = _0x5096de?.["filter"](_0x3ab5f0 => !_0x3ab5f0?.["choose"])?.[0]?.["index"] || 1;
  ...
  async anniversary2024_titleList(_0x20294f = {}) {
    try {
      ...
      if (_0x314d39?.["success"]) {
        ...
        let _0x50c96f = _0x48fae2.time("yyyy-MM-dd");
        let _0x47cf46 = guessTitleInfoList.filter(_0xbfdfda => _0xbfdfda.gameDate == _0x50c96f);
  ...
  async anniversary2024_titleList_award(_0xd23ab7 = {}) {
    try {
      ...
      if (_0x315eda?.["success"]) {
        ...
        let _0x92e460 = _0x48fae2.time("yyyy-MM-dd");
        let _0x154084 = guessTitleInfoList.filter(_0x1f2332 => _0x1f2332.gameDate == _0x92e460);
    ...
    try {
      ...
      };
      {
        ...
        if (_0xd27813?.["success"]) {
          ...
          let _0x327e30 = _0x4295aa.filter(_0x48810c => _0x48810c.currency == "UNBOX_CHANCE");
          let _0x3d3f2e = _0x327e30?.[0]?.["balance"] || 0;
      ...
      if (_0x2705d0?.["success"]) {
        ...
        for (let _0xea3e7c of _0x1a725b) {
          if (!_0xea3e7c.received) {
            ...
            let _0x3b64d7 = new Date(_0xea3e7c.receiveEndTime);
            let _0x23821d = Date.now();
  ...
  dragonBoat2024_parse_item(_0x85cec7) {
    ...
    for (let _0x3edcdb of _0x85cec7) {
      ...
      let _0x5d2704 = _0x25b2bb[_0x209081] || "[" + _0x209081 + "]";
      let _0x5d34b5 = _0x3edcdb.balance || _0x3edcdb.amount || 0;
      const _0x1ae5ba = {
        currency: _0x209081,
        type: _0x5d2704,
        amount: _0x5d34b5
    ...
    try {
      ...
      };
      {
        ...
        if (_0x55f1fc?.["success"]) {
          ...
          let _0x439baf = _0x5699c9.filter(_0x37267b => _0x37267b.currency == "PUSH_TIMES");
          let _0xd9daab = _0x439baf?.[0]?.["balance"] || 0;
      ...
      }
      {
        ...
        if (_0x2c3add?.["success"]) {
          ...
          let _0x5c2a8f = this.dragonBoat2024_parse_item(accountCurrencyList);
          let _0x3d5213 = _0x5c2a8f.filter(_0x354301 => _0x354301.currency == "COIN");
          let _0xd24213 = _0x5c2a8f.filter(_0x51ae04 => _0x51ae04.currency == "RICH_CARD_GAME");
          ...
          let _0x379c46 = Math.min(_0x1d8383, this.rich_card);
...
async function _0x35a7e6(_0x19e1ca = 0) {
  ...
  try {
    ...
    let {
      ...
      result: _0x44e806
    } = await _0x41e2cc.request(_0x3b901f);
    if (_0x3920d4 != 200) {
...
async function _0x6f15d7() {
  ...
  try {
    ...
    let {
      ...
      result: _0x596637
    } = await _0x41e2cc.request(_0x48e807);
    if (_0x5088f1 != 200) {
      return Promise.resolve();
    }
...
function _0x43ee01(_0x13bb0e) {
  return new class {
    ...
    log(_0x2f0d68, _0x4e8b45 = {}) {
      ...
      Object.assign(_0x45e331, _0x4e8b45);
      if (_0x45e331.time) {
        let _0x44a18e = _0x45e331.fmt || "hh:mm:ss";
        _0x2f0d68 = "[" + this.time(_0x44a18e) + "]" + _0x2f0d68;
      }
      if (_0x45e331.notify) {
        this.notifyStr.push(_0x2f0d68);
      }
      if (_0x45e331.console) {
    ...
    async threadTask(_0x7c23ac, _0x77c837) {
      ...
      while (_0x77c837--) {
        _0x3adcb4.push(this.threads(_0x7c23ac, _0x2abf53));
      }
    ...
    padStr(_0x4d6fba, _0x4371de, _0x1d1752 = {}) {
      ...
      let _0x1e8ba3 = _0x1d1752.mode || "l";
      let _0xbc7d23 = String(_0x4d6fba);
      let _0x1da39c = _0x4371de > _0xbc7d23.length ? _0x4371de - _0xbc7d23.length : 0;
      let _0x23267d = "";
    ...
    str2json(_0x320966, _0x1093e6 = false) {
      ...
      for (let _0xeacb7e of _0x320966.split("&")) {
        ...
        let _0x1bdae2 = _0xeacb7e.substr(_0x391c9d + 1);
        if (_0x1093e6) {
    ...
    async exitNow() {
      ...
      let _0x2df9a5 = (_0x851347 - this.startTime) / 1000;
      this.log("");
      const _0x210752 = {
        time: true
      };
    ...
    async wait_until(_0x1fb7c3, _0x24f6bb = {}) {
      ...
      let _0x5d9980 = _0x24f6bb.interval || default_wait_interval;
      let _0x30706b = _0x24f6bb.limit || default_wait_limit;
      let _0x557f0f = _0x24f6bb.ahead || default_wait_ahead;
      ...
      let _0x1ea56c = this.time("hh:mm:ss.S", _0x10103f);
      let _0x1cb325 = Date.now();
